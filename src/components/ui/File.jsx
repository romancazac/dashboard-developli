...
export const File = ({ name, size, onClick }) => {
   ...
   return (
      <div className="flex flex-[0_1_calc(50%-12px)] gap-3  p-3 bg-[#F6F8F9] rounded-xl md:flex-[0_1_100%]">
         <ButtonIcon
            icon={false}
         ...
         <div className='flex-auto'>
            <h4 className="font-bold mb-1 max-w-[200px] overflow-hidden sm:max-w-[150px]">{name}</h4>
