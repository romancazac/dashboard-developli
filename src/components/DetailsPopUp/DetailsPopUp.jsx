...
export default function DetailsPopUp({ open, handleOpen, name, author, avatar, country, experience, level, requirements, salary, text, types }) {

  return (
    <Fragment>

      <Dialog size="xl" open={open} handler={handleOpen} className="max-w-[900px!important] min-w-[auto] md:min-w-[90%] p-5">
