...
export const Registration = () => {
  ...
  return (
    ...
    >
      ...
      <Form>
        <div className='mb-5 '>
          <label className='text-blackColor font-bold mb-1 block text-sm'>User Name
            <ErrorMessage name="username" component={'span'} className='text-[10px] text-' />
          </label>
        ...
        <div className="flex gap-4">
          ...
          <Link to='/' className='bg-[#F3F3F3] text-gray px-6 py-3 font-semibold rounded-2xl hover:scale-105 ease-in-out duration-75 '>Cancel</Link>
